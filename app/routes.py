...
def add_students():
    ...
    if form.validate_on_submit():
        new_student = Student(rollno=form.rollno.data,name=form.name.data,feesamount=form.feesamount.data,paymentmode=form.paymentmode.data)
...
def export_to_pdf():
    ...
    for student in students:
        pdf.cell(200,10,text=f"{student.rollno} - {student.name} - {student.feesamount} - {student.paymentmode}", ln=True)
